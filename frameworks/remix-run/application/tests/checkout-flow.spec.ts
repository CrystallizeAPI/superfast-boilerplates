...
const getRequestBody = (
	query: typeof deleteOrderMutation | typeof orderQuery,
	id: string | null
...
test.describe('Checkout flow', () => {
  test('makes an order using crystal coin with guest user and confirms the order in the API', async ({ page, baseURL }) => {
    const customer = {
        firstname: "John",
        lastname: "Smith",
    ...
    await page
      .locator('[data-testid="guest-checkout-button"]')
