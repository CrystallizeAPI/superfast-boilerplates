...
import { alterCartItemsAndCartTotalsBasedOnSavings, alterCartTotalsBasedOnVouchers, hydrateCart } from './cart';
...
export async function handleAndSaveCart(cart: any, providedCartId: string, voucher?: Voucher): Promise<CartWrapper> {
    ...
    const lots = extractDisountLotFromItemsBasedOnXForYTopic(cartWrapper.cart.cart.items);
