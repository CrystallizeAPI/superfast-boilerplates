...
export const HydratedCart: React.FC = () => {
  ...
  let voucherCode = remoteCart?.extra?.voucher;
          ...
          <div className="w-full flex items-center">
            <div className="overflow-hidden w-[200px] ">
              <div className="-ml-[50px]">
                <iframe
                  width="300px"
                  src="https://embed.lottiefiles.com/animation/823"
                />
              </div>
            </div>
            <div className="mt-10">
              <div className="flex  pb-2 text-3xl font-semibold ">
                {_t("cart.whoaempty")}
              </div>
            ...
            <div>
              {total && (
                <div className="flex flex-col gap-2 border-b-2 border-grey4 py-4 items-end">
                  ...
                  {voucherCode && voucherCode !== "deleteall" && (
                    <div className="flex text-grey3 text-sm justify-between w-60">
